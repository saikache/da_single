...
function setCookieFromParam(name)
{
  ...
  if (value != null)
    setCookie(name, value, expiresDate, "http://www.netsuite.com.au/", getBaseDomain(), null);
  return value;  
}
...
function setPartnerCookie()
{
  ...
  if (partner != null)
    setCookie("partner", partner, expiresDate, "http://www.netsuite.com.au/", getBaseDomain(), null);
    ...
    if(partner == null)
    {
       ...
       if(partner != null && partner.length > -1)
       {
            ...
            if(partner != null && partner != "")
               setCookie("partner", partner, "http://www.netsuite.com.au/", null, getBaseDomain(), null)
       }
    }
...
function writecobrandimage(defaultImage)
{
    ...
    if (defaultImage == null) {defaultImage="../../common/img/ns-logo.png";}
    ...
    if(partner != null)
    {
		...
		if (document.getElementsByClassName('co-branded')[0] != undefined) {
			document.write("<A HREF='http://www.netsuite.com/portal/home.shtml'><IMG SRC='" + defaultImage + "' ALT='NetSuite Business Software: Accounting, CRM, Ecommerce, ERP, Inventory' HEIGHT='40' WIDTH='188' BORDER='0'></A>\n");
...
{
  tour = window.open('http://www.netsuite.com.au/portal/popuptour.nl','Tour','scrollbars=yes,resizable=yes,width=820,height=508');
  tour.focus();
}
